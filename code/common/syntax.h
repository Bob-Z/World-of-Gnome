...
#define MAP_KEY_NEXT_COL_WIDTH	"next_col_width"
#define MAP_KEY_NEXT_COL_HEIGHT	"next_col_height"
#define MAP_KEY_NEXT_ROW_WIDTH	"next_row_width"
#define MAP_KEY_NEXT_ROW_HEIGHT	"next_row_height"
